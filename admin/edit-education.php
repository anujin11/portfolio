...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Боловсрол засах</strong></h1>
		<form action="" method="POST" enctype="multipart/form-data">
			<div class="row">
						...
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										<label class="form-label" for="education_desc">Тайлбар</label>
				...
				<div class="col-6">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0">Боловсрол идэвхтэй эсэх</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
