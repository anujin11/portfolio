...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3">Хяналтын самбар</h1>
		<div class="row">
								...
								<div class="card-body">
									...
									<div class="mb-0">
										<span class="text-success">
											<span class="text-muted">Нийт бүтээл</span>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<h5 class="card-title">Боловсрол</h5>
										</div>
									...
									<div class="mb-0">
										<span class="text-success">
											<span class="text-muted">Нийт</span>
									</div>
								</div>
							</div>
						</div>
