...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Бүтээл нэмэх</strong> </h1>
		<form action="" method="POST" enctype="multipart/form-data">
			<div class="row">
				<div class="col-12 col-lg-4 d-flex">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0">Бүтээлийн мэдээлэл</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										<label class="form-label" for="inputTitle">Бүтээлийн нэр</label>
										<input type="text" class="form-control" id="inputTitle"
											placeholder="Нэр" name="portifolio_title">
									</div>
									<div class="mb-3">
										<label class="form-label" for="portifolio_desc">Бүтээлийн тайлбар</label>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="text-center">
										...
										<div class="mt-2">
											<button type="button" class="btn btn-primary">Зураг оруулах
