...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Миний</strong> Тухай</h1>
		<div class="row">
			<div class="col-md-3 col-xl-3">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Миний тухай</h5>
					</div>
			...
			<div class="col-md-9 col-xl-9">
				<div class="tab-content">
								...
								<form action="" method="POST">
									<div class="row">
										...
										<div class="col-6">
											...
											<div class="mb-3">
												<label class="form-label" for="inputage">Нас</label>
												<input type="text" class="form-control" id="inputage"
													placeholder="Нас"
													value="<?php echo clean($edit_about_age); ?>" name="about_age">
											</div>
											<div class="mb-3">
												<label class="form-label" for="inputexp">Туршлага</label>
												<input type="text" class="form-control" id="inputexp"
													placeholder="Enter Your  Experience"
													value="<?php echo clean($edit_about_exp); ?>" name="about_exp">
											</div>
											<div class="mb-3">
												<label class="form-label" for="inputaboutexp">Олон жилийн туршлага</label>
											...
											<div class="mb-3">
												<label class="form-label" for="inputproject">Бүтээл</label>
										...
										<div class="col-6">
											...
											<div class="mb-3">
												<label class="form-label" for="inputhire">Утасны дугаар</label>
					...
					<div class="tab-pane fade" id="photo" role="tabpanel">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title mb-0">Зураг</h5>
							</div>
							<div class="card-body">
								<h5 class="card-title">Зураг</h5>
								<div class="col-md-12">
									<div class="text-center">
										...
										<form action="" method="POST" enctype="multipart/form-data">
											<div class="mt-2">
												<button type="button" class="btn btn-success">Зураг сонгох
