...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Хэрэглэгч нэмэх</strong></h1>
								...
								<div class="col-md-12">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="inputUsername"
											placeholder="Нэр оруулах" name="user_full_name">
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputUsername">Нэвтрэх нэр</label>
										<input type="text" class="form-control" id="inputUsername"
											placeholder="Нэвтрэх нэр" name="username">
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputEmail">Имайл хаяг</label>
										<input type="email" class="form-control" id="inputEmail"
											placeholder="Имайл хаяг оруулах" name="email">
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="mb-3">
										...
										<input type="password" class="form-control" id="inputPasswordNew"
											placeholder="Нууц үг оруулах" name="password">
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputPasswordNew2">Нууц үг давтах</label>
										<input type="password" class="form-control" id="inputPasswordNew2"
											placeholder="Нууц үг давтах" name="verify_password">
									</div>
									<div class="mt-4">
