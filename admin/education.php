			...
			<div class="card-body">
				<table class="table dataTable table-striped table-hover">
					<thead>
						<tr>
							<th>Сурсан жил</th>
							<th>Боловсролын цол</th>
							<th>Боловсролын тайлбар</th>
							<th>Идэвхтэй байгаа эсэх</th>
							<th>Үйлдлүүд</th>
						</tr>
					</thead>
					<tbody>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">Боловсрол устгах</h5>
							<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>
						<div class="modal-body m-3">
							<p class="mb-0">Та энэ боловсролыг устгах уу?</p>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Цуцлах</button>
							<a class="btn btn-primary">Устгах</a>
						</div>
					</div>
				</div>
			</div>
