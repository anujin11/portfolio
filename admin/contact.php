...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Холбоо барих мэдээлэл</strong></h1>
		<div class="row">
			<div class="col-md-3 col-xl-3">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Холбоо барих</h5>
					</div>
			...
			<div class="col-md-9 col-xl-9">
				<div class="tab-content">
							...
							<div class="card-body">
								<form action="" method="POST">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												<label class="form-label" for="inputcontactinfo">Холбоо барих мэдээлэл</label>
					...
					<div class="tab-pane fade" id="email" role="tabpanel">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title mb-0">Имайл хаяг & Утасны дугаар</h5>
							</div>
							<div class="card-body">
								<form action="" method="POST">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												<label class="form-label" for="contact_email">Имайл хаяг</label>
											...
											<div class="mb-3">
												<label class="form-label" for="contact_phone">Утасны дугаар</label>
									...
									<button type="submit" name="email" class="btn btn-primary">Хадгалах</button>
								</form>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane fade" id="social" role="tabpanel">
						<div class="card">
							<div class="card-header">
								<h5 class="card-title mb-0">Сошиал линк</h5>
							</div>
							<div class="card-body">
								<form action="" method="POST">
									<div class="row">
									...
									<button type="submit" name="social" class="btn btn-primary">Хадгалах</button>
								</form>
							</div>
						</div>
					</div>
