...
<main class="content">
	<div class="container-fluid p-0">
		<div class="row">
			<div class="col-md-6">
				<h1 class="h3 mb-3"><strong>Бүх хэрэглэгч</strong></h1>
			</div>
			<div class="col-md-6 text-md-end">
				<a href="add-user.php" class="btn btn-pill btn-primary float-right"><i class="align-middle"
						data-feather="user-plus"></i>Хэрэглэгч нэмэх</a>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body m-3">
							<p class="mb-0">Та хэрэглэгчийг устгах уу?</p>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Цуцлах</button>
							<a class="btn btn-primary">Хэрэглэгч устгах</a>
						</div>
					</div>
				</div>
			</div>
