			...
			<div class="col-md-3 col-xl-3">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Сайт нэр</h5>
					</div>
							...
							<div class="card-body">
								<form action="" method="POST">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												<label class="form-label" for="inputSitename">Сайт нэр</label>
												<input type="text" class="form-control" id="inputSitename"
													placeholder="Enter Site Name"
													value="<?php echo clean($edit_site_name); ?>" name="site_name">
											</div>
											<div class="mb-3">
												<label class="form-label" for="inputSiteDesc">Сайт тайлбар</label>
								...
								<div class="col-md-12">
									<div class="text-center">
										...
										<form action="" method="POST" enctype="multipart/form-data">
											<div class="mt-2">
												<button type="button" class="btn btn-success">Лого оруулах
