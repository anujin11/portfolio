...
<main class="content">
	<div class="container-fluid p-0">
		<h1 class="h3 mb-3"><strong>Боловсрол нэмэх</strong></h1>
		<form action="" method="POST" enctype="multipart/form-data">
			<div class="row">
				<div class="col-6">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0">Боловсролын мэдээлэл</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
									<div class="mb-3">
										<label class="form-label" for="inputTitle">Нэр</label>
										<input type="text" class="form-control" id="inputTitle"
											placeholder="Нэр" name="education_title">
									</div>
									<div class="mb-3">
										<label class="form-label" for="education_desc">Бүтээлийн тайлбар</label>
										<textarea type="text" rows="4" class="form-control" id="education_desc"
											placeholder="Тайлбар" name="education_desc"></textarea>
									</div>
									<div class="mb-3">
										<label class="form-label" for="inputurl">Сурсан жил</label>
										<input type="text" class="form-control" id="inputurl"
											placeholder="Жил" name="education_year">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-6">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0">Идэвхтэй эсэх</h5>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-12">
